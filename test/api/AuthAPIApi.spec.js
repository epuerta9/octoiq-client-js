...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenApi.AuthAPIApi();
  });

  describe('(package)', function() {
    describe('AuthAPIApi', function() {
      ...
      describe('authLogout', function() {
        it('should call authLogout successfully', function(done) {
          // TODO: uncomment authLogout call and complete the assertions
          /*

          instance.authLogout(function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('authWhoAmI', function() {
        it('should call authWhoAmI successfully', function(done) {
          // TODO: uncomment, update parameter values for authWhoAmI call and complete the assertions
          /*
          var opts = {};

          instance.authWhoAmI(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(OpenApi.AuthWhoAmIResponse);
