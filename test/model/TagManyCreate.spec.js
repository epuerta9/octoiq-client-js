...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TagManyCreate', function() {
      beforeEach(function() {
        instance = new OpenApi.TagManyCreate();
      });

      it('should create an instance of TagManyCreate', function() {
        // TODO: update the code to test TagManyCreate
        expect(instance).to.be.a(OpenApi.TagManyCreate);
      });
