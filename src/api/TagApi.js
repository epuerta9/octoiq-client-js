...
export class TagApi {
    ...
    */
     ...
     * @callback moduleapi/TagApi~createTagCallback
     ...
     * @callback moduleapi/TagApi~getTagCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Tag{ data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @callback moduleapi/TagApi~getTagsOrgCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Tag{ data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.jwt authorization
     * @param {module:api/TagApi~getTagsOrgCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
     ...
     * @callback moduleapi/TagApi~updateTagCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Tag{ data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
