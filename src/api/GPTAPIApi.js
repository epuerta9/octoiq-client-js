...
/**
* GPTAPI service.
* @module api/GPTAPIApi
* @version 0.0.1
*/
export class GPTAPIApi {

    /**
    * Constructs a new GPTAPIApi. 
    * @alias module:api/GPTAPIApi
    * @class
    ...
    */
     ...
     * @callback moduleapi/GPTAPIApi~gPTRequestCallback
     ...
     * @param {module:api/GPTAPIApi~gPTRequestCallback} callback The callback function, accepting three arguments: error, data, response
